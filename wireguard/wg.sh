...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/bagusid93/hss/main/sc3 | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${julak}/main/wireguard/addwg.sh"
wget -O delwg "https://${julak}/main/wireguard/delwg.sh"
wget -O renewwg "https://${julak}/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
