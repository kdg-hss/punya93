...
version=$(cat /home/ver)
new_version=$( curl sS https://raw.githubusercontent.com/bagusid93/sc3/main/versi | grep $version )
#Status Version
...
wget -O menu-ssws "https://${julak}/main/menu/menu-ssws.sh"
wget -O running "https://${julak}/main/menu/running.sh"
wget -O clearcache "https://${julak}/main/menu/clearcache.sh"
wget -O menu-trgo "https://${julak}/main/menu/menu-trgo.sh"
...
wget -O trialvless "https://${julak}/main/xray/trialvless.sh"
wget -O trialtrojan "https://${julak}/main/xray/trialtrojan.sh"
wget -O addtrgo "https://${julak}/main/xray/addtrgo.sh"
wget -O trialtrojango "https://${julak}/main/xray/trialtrojango.sh"
wget -O deltrgo "https://${julak}/main/xray/deltrgo.sh"
wget -O renewtrgo "https://${julak}/main/xray/renewtrgo.sh"
wget -O cektrgo "https://${julak}/main/xray/cektrgo.sh"
wget -O cf "https://${julak}/main/ssh/cf.sh"
wget -O menu-bckp "https://${julak}/main/menu/menu-bckp.sh"
wget -O add-ssws "https://${julak}/main/xray/add-ssws.sh"
wget -O add-v2ray "https://${julak}/main/xray/add-v2ray.sh"
wget -O wireguard "https://${julak}/main/wireguard/add-wireguard.sh"
